        ...
        <div class="cart-item-details-grid">
          ...
          <div class="delivery-options">
            ...
            <div class="delivery-option">
              <input type="radio" checked class="delivery-option-input" name="delivery-option-${checkproduct.id}">
              <div>
            ...
            <div class="delivery-option">
              <input type="radio" class="delivery-option-input" name="delivery-option-${checkproduct.id}">
              <div>
                <div class="delivery-option-date">
                  Wednesday, June 15
                </div>
